...
<head>
    ...
    <title>Arabica Café Company</title>
    ...
    <main>
        ...
        <div id="cafe-features" class="coffee-page cp">
            ...
            <div class="cup-of-coffee-container">
                <div class="col-1">
                    <div class="title-icon-container">
                        <div class="title-container">
                            ...
                            Comfortable indoor seating in a cozy and inviting atmosphere.
                            </div>
                        </div>
                    ...
                    <div class="title-icon-container">
                        <div class="title-container">
                            ...
                            <div class="heading-h2">
                            Bring your furry friends along to our pet-friendly cafe.
                            </div>
                        </div>
                    ...
                    <div class="title-icon-container">
                        <div class="title-container">
                            ...
                            <div class="heading-h2">
                            Grab a cup of coffee, a latte, or a snack on the go.
                            </div>
                        </div>
                ...
                <img class="cup-of-coffee" src="images/landing-page/cup-of-coffee-background.png" alt="Cup of Coffee, a Latte">
                ...
                <div class="col-2">
                    <div class="title-icon-container">
                        ...
                        <div class="title-container">
                            ...
                            <div class="heading-h2">
                            Our cafe is accessible to everyone with wheelchair accommodations.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="title-icon-container">
                        ...
                        <div class="title-container">
                            ...
                            <div class="heading-h2">
                            Enjoy a variety of delicious vegan choices.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="title-icon-container">
                        ...
                        <div class="title-container">
                            ...
                            <div class="heading-h2">
                            Cyclists are welcome to take a break and enjoy a refreshing coffee.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="testimonials-carousel-container TC">
            <div class="carousel-item-container">
                ...
                <div class="quote-h1 primary-font">
                    "Coffee: a flavorful awakening that fuels both body and mind, 
                    fostering moments of connection and contemplation in its rich aroma and comforting warmth."
                </div>
    ...
    <br>
        ...
        <div class="menu-snippet-container MSC">
            ...
            <div class="menu-heading-title-container MHC">
                ...
                <div class="heading-h2">
                Discover our favorite coffee flavors, crafted to delight your senses with every sip. Experience a blend of rich aromas and bold tastes, curated for your enjoyment.
                </div>
            </div>
        ...
        <div class="read-news-container RNC">
            <div class="news-heading-container NHC">
                ...
                <div class="heading-h2">
                Visit our page for the newest updates, stories, and insights that reflect our journey and passions.
                </div>
            </div>
...
<fo $ action="index.php" method="POST">
